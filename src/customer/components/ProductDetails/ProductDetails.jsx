            ...
            <Grid item xs={5}>
              ...
              <Box className="mt-5 space-y-3">
                <Grid container alignItems="center" gap={2}>
                  ...
                  <Grid item xs={7}>
                      <LinearProgress sx={{bgcolor:"#d0d0d0", boederRadius:4, height:7}} variant="determinate" value={40} color="success"/>
                  </Grid>
                </Grid>
                <Grid container alignItems="center" gap={2}>
                  <Grid item xs={2}>
                  ...
                  <Grid item xs={7}>
                      <LinearProgress sx={{bgcolor:"#d0d0d0", boederRadius:4, height:7}} variant="determinate" value={30} color="success"/>
                  </Grid>
                </Grid>
                <Grid container alignItems="center" gap={2}>
                  <Grid item xs={2}>
                  ...
                  <Grid item xs={7}>
                      <LinearProgress sx={{bgcolor:"#d0d0d0", boederRadius:4, height:7}} variant="determinate" value={25} />
                  </Grid>
                </Grid>
                <Grid container alignItems="center" gap={2}>
                  <Grid item xs={2}>
                  ...
                  <Grid item xs={7}>
                      <LinearProgress sx={{bgcolor:"#d0d0d0", boederRadius:4, height:7}} variant="determinate" value={20} color="warning"/>
                  </Grid>
                </Grid>
                <Grid container alignItems="center" gap={2}>
                  <Grid item xs={2}>
                  ...
                  <Grid item xs={7}>
                      <LinearProgress sx={{bgcolor:"#d0d0d0", boederRadius:4, height:7}} variant="determinate" value={10} color="error"/>
                  </Grid>
                </Grid>
